...
async fn get_server_data() -> anyhow::Result<()> {
    let ptero_info_header = HeaderMap::new();
    ptero_info_header.insert("Authorization", "Bearer ptlc_8JGKmhuz2JydQ0Ax8Ko7MKopPTeWln8mJi2cmZm0Uam");
    ptero_info_header.insert("Accept", "application/json");
    ptero_info_header.insert("application/json", "application/json");
